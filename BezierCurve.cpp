...
const QPainterPath &BezierCurve::GetPath()
{
    m_path = QPainterPath();
...
QPointF BezierCurve::GetLineStart(int i) const
{
    QPointF pt;
    QPoint pt1 = at(i);
...
QPointF BezierCurve::GetLineEnd(int i) const
{
    QPointF pt;
    QPoint pt1 = at(i);
    QPoint pt2 = at((i+1) % count());
...
float BezierCurve::GetDistance(QPoint pt1, QPoint pt2) const
{
